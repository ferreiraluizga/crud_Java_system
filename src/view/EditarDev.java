...
public class EditarDev extends javax.swing.JFrame {
    ...
    public void atribuirDadosAtuais(int id) {
        ...
        String genero = desenvolvedor.getGenero();
        if (genero != null) {
        ...
        String areas = desenvolvedor.getAreas();
        if (areas != null) {
        ...
        String estadoCivil = desenvolvedor.getEstadoCivil();
        if (estadoCivil != null) {
        ...
        String estado = desenvolvedor.getEstado();
        if (estado != null) {
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            ...
            new Desenvolvedor(id, nome, nascimento, genero, estadoCivil, areas, cep, endereco, 
                    bairro, complemento, estado, cidade, celular, telefone).editarDev(id);
